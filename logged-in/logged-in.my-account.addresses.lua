...
http.page_start("My Account > Adresses")
http.request_batch({
	{"GET", "https://managed-woocommerce.liquidwebsites.com/my-account/edit-address/", auto_decompress=true}
})
...
http.page_end("My Account > Adresses")
