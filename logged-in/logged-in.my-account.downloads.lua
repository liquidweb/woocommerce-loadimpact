...
http.page_start("My Account -> Downloads")
http.request_batch({
	{"GET", "https://managed-woocommerce.liquidwebsites.com/my-account/downloads/", auto_decompress=true}
})
...
http.page_end("My Account -> Downloads")
