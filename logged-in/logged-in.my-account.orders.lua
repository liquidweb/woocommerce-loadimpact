...
http.page_start("My Account -> Orders")
http.request_batch({
	{"GET", "https://managed-woocommerce.liquidwebsites.com/my-account/orders/", auto_decompress=true}
})
...
http.page_end("My Account -> Orders")
